...
export function useSportsMarketRows({
  ...
  const handleSportsPropChange = useCallback(
    (propId: string, field: keyof AdminSportsPropState, value: string) => {
      setSportsForm((prev) => ({
        ...prev,
  ...
  const removeSportsProp = useCallback(
    (propId: string) => {
  ...
  const handleSportsCustomMarketChange = useCallback(
    (marketId: string, field: keyof AdminSportsCustomMarketState, value: string) => {
      setSportsForm((prev) => {
  ...
  const removeSportsCustomMarket = useCallback(
    (marketId: string) => {
