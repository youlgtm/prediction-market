              ...
              <>
                  ...
                  <div className="space-y-3 rounded-md border p-4">
                    <div className="space-y-1">
                      ...
                      {sportsForm.eventVariant !== 'standard' && (
                        <p className="text-sm text-muted-foreground">{t('The base game market is always created for sports games. Use this toggle to decide whether the base moneyline should include home / draw / away or only home / away.')}</p>
                      )}
                    </div>
                ...
                {sportsForm.section === 'games' && (sportsForm.eventVariant === 'exact_score' || sportsForm.eventVariant === 'halftime_result') && (
                  <div className="rounded-md border p-4">
                    <p className="text-sm text-muted-foreground">{t('This pack is generated automatically from the selected teams and start time, and always includes the mandatory moneyline base markets using the draw selection above.')}</p>
                  </div>
                )}
                ...
                {sportsForm.eventVariant === 'custom' && (
                  <div className="space-y-4 rounded-md border p-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">{t('Choose any market type. Moneyline base markets are added automatically using the draw selection above, and row order is sent as the market group threshold automatically.')}</p>
                    </div>
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="home">
                                    {sportsForm.teams[0]?.name || t('Home team')}
                                    {' '}
                                    {t('icon')}
                                  </SelectItem>
                                  <SelectItem value="away">
                                    {sportsForm.teams[1]?.name || t('Away team')}
                                    {' '}
                                    {t('icon')}
                                  </SelectItem>
                                </SelectContent>
                ...
                {sportsForm.section === 'props' && sportsForm.eventVariant !== 'custom' && (
                  <div className="space-y-4 rounded-md border p-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">{t('Each row becomes one generated market with Over and Under outcomes.')}</p>
                    </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">{t('Eg. Will BTC close above $110k on Mar 31, 2028?')}</p>
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">{t('Eg. Which BTC milestones will be reached by Dec 31, 2028?')}</p>
                      <div className="mt-3 space-y-2 text-xs">
                        <div className="flex items-center justify-between gap-3 rounded-md bg-muted px-2 py-1">
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">{t('Eg. Who will win the 2028 U.S. presidential election?')}</p>
                      <div className="mt-3 space-y-2 text-xs">
                        <div className="flex items-center justify-between gap-3 rounded-md bg-muted px-2 py-1">
