      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t('Add a display name so this wallet can be recognized in mirrored market sources.')}</DialogDescription>
          </DialogHeader>
          <div className="grid gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              {eoaAddress ?? t('Wallet not connected')}
            </p>
          </div>
          <DialogFooter>
            <Button
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t('Experimental output generated by your configured AI provider. We recommend paid models (for example xAI or Manus with internet access) for better quality. Validate all text manually, including dates and links. You are responsible for the final rules.')}</DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
              type="button"
      ...
      <Dialog open={resetFormDialogOpen} onOpenChange={setResetFormDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t('This will remove all filled fields, uploaded images, and pre-sign checks from the wizard.')}</DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
              type="button"
            ...
            <Button type="button" variant="destructive" onClick={confirmResetForm}>{t('Clear form')}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={finalPreviewDialogOpen} onOpenChange={setFinalPreviewDialogOpen}>
        <DialogContent className="max-h-[90vh] overflow-hidden p-0 sm:max-w-6xl">
          <DialogHeader className="sr-only">
            ...
            <DialogDescription>{t('Review how your event and markets will look before starting signatures.')}</DialogDescription>
          </DialogHeader>
          ...
          <div className="flex max-h-[90vh] flex-col">
            ...
            <div className="flex flex-col-reverse gap-2 border-t p-4 sm:flex-row sm:justify-end">
              ...
              <Button type="button" onClick={continueFromFinalPreview}>{t('Continue to sign')}</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
