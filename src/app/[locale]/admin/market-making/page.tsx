  ...
  return (
    <MarketMakingDiscovery
      ...
      copy={{
        ...
        sponsorPremium: t('Extra (optional)'),
        sponsorPremiumHelp: t('Higher payments can make campaigns more attractive to market makers'),
        ...
        insufficientBalance: t('Insufficient USDC in your connected wallet'),
        ...
        payImportFee: t('Pay import fee'),
        reserveDeployment: t('Reserve deployment'),
        fundMarketMakerCampaign: t('Fund market maker campaign'),
        confirmNetworkSwitch: t('Confirm network switch'),
        ...
        cancelImport: t('Cancel import sponsorship'),
        cancellingImport: t('Cancelling import sponsorship...'),
        deploymentRelayerPending: t('The escrow relayer is finalizing this sponsorship.'),
