  ...
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M9.722 2.32c.649-.866 2.025-.36 1.962.718l-.257 4.337h4.323c.927 0 1.456 1.058.9 1.8l-6.372 8.505c-.65.866-2.026.36-1.962-.718l.256-4.337H4.25a1.125 1.125 0 0 1-.9-1.8zm-4.223 8.555h4.002a.876.876 0 0 1 .873.927l-.182 3.073 4.31-5.75h-4.003a.876.876 0 0 1-.874-.927l.182-3.074z"
        clipRule="evenodd"
      />
    </svg>
  )
...
function TemperatureIcon() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M15.5 3.25H12.75M14 6.25H12.75M15.5 9.25H12.75M7.25 12V6.75M4.75 10.306V4.25C4.75 2.869 5.869 1.75 7.25 1.75C8.631 1.75 9.75 2.869 9.75 4.25V10.306C10.367 10.937 10.75 11.798 10.75 12.75C10.75 14.683 9.183 16.25 7.25 16.25C5.317 16.25 3.75 14.683 3.75 12.75C3.75 11.798 4.133 10.937 4.75 10.306Z"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.5"
...
function TornadoesIcon() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M14.295,9c-.927,.733-3.173,1.25-5.795,1.25-3.452,0-6.25-.895-6.25-2,0-.603,.834-1.144,2.153-1.51M14.245,12c-.843,.591-2.65,1-4.745,1-2.899,0-5.25-.784-5.25-1.75,0-.47,.555-.896,1.459-1.211M11.557,15c-.757,.305-1.901,.5-3.182,.5-2.278,0-4.125-.616-4.125-1.375,0-.616,1.214-1.137,2.887-1.312"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.5"
...
function HurricanesIcon() {
  return (
    <svg viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M2.75,9H13.25c1.105,0,2,.895,2,2s-.895,2-2,2c-.895,0-1.653-.588-1.908-1.399M2.75,12.25H7c1.105,0,2,.895,2,2s-.895,2-2,2c-.895,0-1.653-.588-1.908-1.399M2.75,5.75H10.75c1.105,0,2-.895,2-2s-.895-2-2-2c-.895,0-1.653,.588-1.908,1.399"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.5"
...
export const categorySidebarInlineIcons: Partial<Record<PlatformCategorySidebarIconKey, () => ReactNode>> = {
