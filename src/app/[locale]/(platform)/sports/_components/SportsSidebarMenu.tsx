    ...
    <>
      ...
      <aside
        ...
        className={cn(
          ...
          independentScroll
            ? `min-[1200px]:flex min-[1200px]:h-full min-[1200px]:min-h-0 min-[1200px]:flex-col min-[1200px]:justify-start min-[1200px]:overflow-y-auto min-[1200px]:overscroll-contain min-[1200px]:pb-8`
            : documentScroll
              ? `min-[1200px]:sticky min-[1200px]:top-29 min-[1200px]:flex min-[1200px]:h-[calc(100dvh-7.25rem)] min-[1200px]:flex-col min-[1200px]:justify-start min-[1200px]:overflow-y-auto min-[1200px]:pb-8`
