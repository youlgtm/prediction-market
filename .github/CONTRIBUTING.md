...
- Run `pnpm lint`, `pnpm fmt`, `pnpm test`, and `pnpm build` before submitting.
...
7. Run `pnpm lint`, `pnpm fmt`, `pnpm test`, and `pnpm build`
...
- `pnpm fmt` formats supported files with Oxfmt.
