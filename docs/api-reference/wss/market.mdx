...
<code><PublicRuntimeServiceUrl service="wsClob" path="/ws/market" /></code>
...
<Callout type="warning">
  Do not continue applying deltas after a missed sequence. A visually plausible but stale
  book can produce incorrect prices and unsafe orders.
</Callout>
